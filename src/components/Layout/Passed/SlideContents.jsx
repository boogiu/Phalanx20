  ...
  if (id === '101') {
    ...
    content = (
      <>
        ...
        우리끼리 장난치고 <br/>
        끝내는게 아니니까, 그것을 증빙하고 <br/>
        확실한 운영 규정과 안내에 대한 <br/>
        준수는 필수적이겠죠!<br/>
        <br/>
        선배 크루 뿐만 아니라, <br/>
        실제 기업들의 연계/후원사들의 <br/>
    ...
    content = (
      <>
        ...
        회사들에서 채용할 때 학점을 보는 <br/>
        이유는, 결국 그 과목의 어려운 이론을 <br/>
        잘 습득했거나 그 지식이 얼마나 <br/>
        쌓이냐가 아니라...<br/>
        <br/>
        4년 이상의 대학 과정 동안에, <br/>
        그 학점을 얼마나 잘 ‘유지’ 하고, <br/>
        ‘관리’ 할 수 있느냐 를 평가하는 <br/>
        지표라는 것이었습니다.<br/> 
        <br/>

        그동안 저는 너무 ‘열정’만 <br/>
        가득했는데.. 그게 다 ‘잠깐‘의 <br/>
        열정, ‘한 번 해보는’ 열정이었어요.<br/>
        <br/> 
        그리고 이런 걸 사회에서는 <br/>
        ‘무책임한 객기’ 라고 하더라구요..ㅠ<br/>
      </>
    );
  }else if (id === '109') {
    ...
    content = (
      <>
        ...
        가치 있는 경력을 쌓고, <br/>
        “나는 실력 있는 기획자“ 라는 것을 <br/>
        어필하고자 한다면, 나에게 돈을 주는 <br/>
        클라이언트, 나를 채용하고자 하는 <br/>
        기업들이 나의 역량과 꾸준함을 <br/>
        신뢰할 수 있어야 하는 것이 <br/>
        필수 입니다.<br/> 
        (우리가 맛있는 김치찌개를 <br/>
    ...
    content = (
      <>
        ...
        실무자 다수가 작성한,<br/>
        <br/> 
        1~3년차 기획자들이 알아두어야 <br/>
        하는 실무 기획에 대한 진행 과정을 <br/>
        메인 내용으로, 팔랑크스 크루들에게 <br/>
        제공되는 핵심 가이드에요!<br/>
        <br/> 
        매주 모든 크루가 1주 단위로 <br/>
        3~4개씩 진행하고, 이를 <br/>
    ...
    content = (
      <>
        ...
        <br/>
        2) [니즈 파악 / 범위 구조화 / <br/>
        심화 내용 / 제안 타진] 의 4단계<br/>
        (1주에 1개)에 걸쳐 기획을 진행하고,<br/>
        <br/> 
        3) 해당 기업/브랜드에게 나의 기획을 <br/>
        실제로 공식적으로 타진하게 됩니다.<br/>
        <br/> 
        4) 그리고 위 과정을 모두 팔랑크스의 <br/>
        ...
        28주 동안, 총 7개의 기업에게 <br/>
        나의 기획안을 직접 공식 발송하는 <br/>
        과정이 팔랑크스의 (필수형)커리큘럼의 <br/>
        ‘핵심’ 이라고 볼 수 있어요 <br/>
        <br/>
        단, 총 4단계로 이루어진 <br/>
        위 과정에서, 본인 스스로 <br/>
        본인의 기획이 마음에 들지 않는 <br/>
        경우도 있고, <br/>
        <br/>
        어떤 크루의 경우 <br/>
        1단계(니즈 파악) 없이, <br/>
        바로 3단계(심화 내용)로 <br/>
        들어가는 분도 있기 때문에, <br/>
        이 순서나 기간은 강제되지는 않아요. <br/>
        <br/>
        본인의 역량과 수준, 그리고 <br/>
        결과물 기준에 맞춰서, <br/>
        동일한 과정을 다시 해서 완성도를 <br/>
        높일 수도, 혹은 30주차 활동 중에 <br/>
        7개보다 더 다수의 기업에게 <br/>
        발송하는 ‘양’ 을 늘릴 수도 있습니다. <br/>
        <br/>

        즉, 30주 중 7번의 실무 기획안을 <br/>
        기업에게 타진해보는 것이 중점이지만, <br/>
        개별 크루의 상황/역량에 따라 <br/>
        7번 그 이상도, 7번 그 이하가 <br/>
        될 수도 있습니다.<br/>
        <br/>
        (필수형) 커리큘럼은 <br/>
        총 6개의 유닛이며, 시즌 시작 이후<br/>
        모두 전체 공개 되어, 각자 자신이 <br/>
        원하는 단계를 진행할 수 있어요! <br/>
        <br/>
    ...
    content = (
      <>
        ...
        팔랑크스는 시즌과 주차의 개념으로 <br/>
        진행되며, 이를 기준으로 총 30주의<br/>
        과정을 정식 수료/졸업의 기준으로 <br/>
        가지고 있어요!<br/>
        <br/>
        팔랑크스 활동 주차 <br/>
        30주차는 크게 아래로 구분됩니다.<br/>
        <br/>
          * 1주차 : 클럽온보딩 주차<br/>
          (견습 + 신입OT + 적응 지원)<br/>
          * 2~29주차 : 실제 기획 <br/>
        ...
        즉, 모든 팔랑크스의 크루는, <br/>
        동일한 시기에 시작 + 동일한 시기에 <br/>
        종료되는 것이 아닌, <br/>
        각자가 들어온 시즌과 주차에 맞추어, <br/>
        매주 본인의 누적 주차가 쌓이며, <br/>
        30주가 되었을 때 졸업하게 되는 <br/>
        시스템입니다. <br/>
        (내가 4주차 일때, 15주차인 선배님도, <br/>
        2주차인 후배도 있겠죠)

        그래서 매번 동일한 크루들과 사람들에게만 <br/>
        피드백 받고 고여있지 않고, 항상 다른,  <br/>
        새로운 학교의 새로운 전공의 <br/>
        사람들과 꾸준히 연계할 수 있도록 <br/>
        되어 있어요!<br/>
        (바뀌지 않는..맨날 정해진 <br/>
        사람들끼리만..이런거..ㄴㄴ )<br/>
        <br/>
    ...
    content = (
      <>
        <div style={{height : "100px"}}>
          <TitleSpan>1년의 4개의 (시즌)</TitleSpan><br/>
        </div>
        팔랑크스는 아래와 같이 <br/>
        1년의 4개의 시즌이며, <br/>
        전국대학연합 동아리이기 때문에 <br/>
        모든 시즌 구성을, 대한민국 2/4년제 <br/>
        대학의 학사 일정 기준을 따라 <br/>
        움직이고 있어요!<br/>
        <br/> 
        (겨울) 시즌 : 1,2월 겨울 방학<br/>
        (봄)   시즌 : 3,4,5 6월 봄 학기<br/>
        (여름) 시즌 : 7,8월 여름 방학<br/>
        (가을) 시즌 : 9,10,11,12월 가을 학기<br/>
        (방학 2개월 & 학기 4개월)<br/><br/>
        <br/>
        ...
        *시험 기간으로 인한 <br/>
        ...
        집계, 관리하는 운영진은 <br/>
        활동해야 합니다. <br/>
        (추후 운영진 지원하실 분들 참고!)<br/>
        <br/>
        ㄱ. 매 시즌이 종료되기 <br/>
        2~4주 전 부터는, 다음 시즌 <br/>
        진행 과정에 대한 예정과 안내가 <br/>
        진행되어, 모든 크루들은 해당 사항을<br/>
        기준으로 숙고하여 다음 시즌에 대한 <br/>
        재등록 여부를 결정할 수 있습니다. <br/> 
        <br/>
        ㄴ. 매 시즌이 시작하는 시점에는 <br/>
        해당 시즌에 내가 쉬어야 하는 주차를 <br/>
        미리 휴식 주차로 신청하여, <br/>
        ...
        시즌 전체를 휴식 신청할 수 있으며,<br/> 
        그럴 경우 다음 시즌까지, <br/>
        팔랑크스 시스템에 해당 크루의 <br/>
        활동 내역을 보관하여 다음 시즌에 <br/>
        복귀할 수 있습니다. <br/>
      </>
    );
  }else if (id === '303') {
    ...
    content = (
      <>
        <div style={{height : "100px"}}>
          <TitleSpan>월요일 시작, <br/>토요일 종료되는 (주차)</TitleSpan><br/>
        </div>
        팔랑크스는 모든 진행 과정을 <br/>
        ‘주차’(월-토)를 기준으로 구성하며, <br/>
        모든 크루들은 매주 팔랑크스 <br/>
        ...
        매주 월요일, <br/>
          ...
          파트장(세부진행)의 시작브리핑을 <br/>
          기준으로, 한 주가 시작되고,<br/>
          <br/>
        매주 토요일, <br/>
        마감 브리핑을 기준으로 한 주의 <br/>
        과정을 종료합니다.<br/>
        <br/> 
        *한 주 내부의 세부적인 사항은, <br/>
    ...
    content = (
      <>
        <div style={{height : "100px"}}>
          <TitleSpan>단, <br/>‘투구’를 모으는 활동은</TitleSpan>
        </div>
        개인의 역량이나 실력에 의해 <br/>
        좌우되는 것이 아니라,<br/>
        <br/>
        ‘안내된 사항’ 에 대한 확실한 <br/>
        인지, 확인, 커뮤니케이션 미스 등에 <br/>
        대한 부분을 체크하고, <br/>
        확인이 되고 있느냐! 입니다.<br/>
        <br/>
        즉, 팔랑크스 활동에 신경을 <br/>
        ...
        <br/> 
        투구는 기본적으로 매주 크루가 <br/> 
        받을 수 있는 투구 전체 양의 50% <br/> 
        정도로 책정되는 것이 기준이어서, <br/> 
        필수로 확인해야 하는 정해진 공지만 <br/> 
        확인해도 문제가 없지만!<br/> 
        <br/> 
        10~20명 의 크루 분 중에 <br/> 
        평균 1명 정도는.. 이러한 <br/> 
        공지나 확인 투표 등을 하지 않아서 <br/> 
        ‘투구’를 미달하는 경우가 생깁니다.ㅠ<br/> 
        <br/> 
        이럴 경우, <br/> 
        그러한 크루분들은 더 이상 <br/> 
        활동의 의지가 없다고 판단되어, <br/> 
        페널티 포인트가 부여되며, <br/> 
        더 나아가 제명까지 이를 수 있습니다.<br/> 
        <br/>  
        주별 활동의 인정 여부는, 잘난 몇명만 <br/> 
        인정되게 하는 것이 아닌!<br/> 
    ...
    content = (
      <>
        ...
        팔랑크스는 팀과 파트로 구성됩니다.<br/> 
        23년 6월까지 소모임 형태가 <br/> 
        종료된 뒤에, 7~8개월의 후원사 연계,<br/> 
        타 클럽의 운영 과정 도입을 통해 <br/> 
        24년 2월 기준 IT / 브랜딩 / 서비스, <br/> 
        이렇게 3개의 분야로 세부 팀을 <br/> 
        이루고 있습니다. <br/> 
        <br/> 
        모든 크루는 <br/> 
        활동 1주차인 클럽 온보딩 과정의 <br/> 
        마지막에, 세부 팀 중 희망하는 <br/> 
        팀을 지원할 수 있으며,<br/>  
        ...
        최대로 가지고,<br/> 
        <br/> 
        ‘파트’ 는 파트장에 선발된 크루의<br/> 
        기획에 맞추어, 특정 산업 분야를 <br/> 
        담당하는 기획 포트폴리오에 <br/> 
        중점을 둡니다.<br/>  
        Ex) IT 세부 팀 내에, <br/> 
        ...
        중소/스타트업들의 실무진이 <br/> 
        평가위원으로 참여하는,<br/>  
        올림피아 기획 대전(2월, 8월)의 <br/> 
        무대에서, 기획 경쟁 PT의 <br/> 
        주요 경쟁 단위가 됩니다.<br/> 
        ex) 팔랑크스 산하, 15개 <br/> 
        파트 중 4개 파트가 선발되는 식<br/> 
        <br/> 
        기획자로서의 본인이 꿈을 <br/> 
        펼치고자 하는 산업군과 <br/> 
        세부 영역을 고려하여, <br/> 
    ...
    content = (
      <>
        ...
        <br/> 
        일반 크루로 활동을 하면서, <br/> 
        자신의 팀 내에서 상대적으로 높은 <br/> 
        역량을 보여주거나,<br/>  
        타 크루에 활동에 도움/지원을 <br/> 
        할 수 있는 가능성을 보여주는 크루는 <br/> 
        심화 크루로 선발 혹은 지원할 수 <br/> 
        있습니다.  <br/> 
        <br/> 
        심화 크루는 <br/> 
        팀장이 전체 크루 수를 고려하여 <br/> 
        선발하며, 일반 크루의 활동 내용, <br/> 
    ...
    content = (
      <>
        ...
        심화 크루는 한 파트를 이끄는 <br/> 
        ‘파트장’(에이스) 과 팀 전반의 <br/> 
        기획을 검수하는 ‘에이전트’(매니저)<br/> 
        형태로 구분되는데,<br/>  
        심화 크루들은 한 세부 팀 내의 <br/> 
        ‘기획실’ 이라는 별도의 단위를 이루어, <br/> 
    ...
    content = (
      <>
        ...
        아무리 자기 눈에 뛰어난 <br/>
        기획안을 작성하였다고 해도, <br/>
        그 사람이 연락이 잘 되지 않고, <br/>
        주어진 안내 사항과 발송된 <br/>
        메시지에 대해 회신이 없는 사람을 <br/>
        사회 구성원으로서의 기본 도덕이 <br/>
        미달된 사람으로 <br/>
        팔랑크스는 생각합니다.
      </>
    );
      ...
      <>
        <div style={{height : "100px"}}>
         <TitleSpan>방패</TitleSpan>
          ...
          모든 크루가 활동을 시작할 때 <br/>
          5개를 기본으로 가지고 시작하며,<br/>
          모두 소멸될 시 제명당할 수 있는 <br/>
          advantage 포인트 입니다. <br/>
          <br/>
          화살을 한 대 맞으면, <br/>
          방패가 하나 사라지는 방식으로써, <br/>
          화살과 방패는 반대의 개념입니다. <br/>
          <br/> 
          방패는, 투구보다 얻기 어려우나, <br/>
          전체 진행 과정에서 심심치 않게 <br/>
          볼 수 있으며, 타 크루에게 좋은 <br/>
          피드백을 주거나, 포럼에 참가하는 등 <br/>
          동아리 활동에 열정적으로 참여하는 <br/>
          크루에게 부여되는 경우가 많습니다.<br/>
          <br/>
          방패는, 추후 졸업할 때 본인의 <br/>
          졸업 성적과 연관이 되기 때문에 <br/>
          유의 깊게 관리하는 것을 <br/>
          추천드립니다.<br/>
          <br/>
          모든 크루가 5개로 시작하며, <br/>
          활동하면서 대부분 20~30개 이상을 <br/>
          유지하며 안정적으로 활동하는 것이 <br/>
          보편적이지만, 규정과 안내를 전혀 <br/>
          읽지 않는 경우 1주에 5개 이상의 <br/>
      ...
      <>
        <div style={{height : "100px"}}>
         <TitleSpan>화살</TitleSpan>
          ...
          기준이 되는 penalty 포인트 입니다.<br/>
          화살을 하나 맞으면, 방패 하나가 <br/>
          사라지기 때문에, 화살은 맞지 않고, <br/>
          방패는 쌓을 수 있도록 유의해야 <br/>
          합니다.<br/>
          <br/>
          화살을 맞는 경우에는, <br/>
          크루의 실력이나 역량 등 <br/>
          ...
          경우는 없습니다.<br/>
          <br/>
          이 역시, 정해진 일정을 놓치거나, <br/>
          혼자만 회신을 하지 않아 전체 진행에 <br/>
          저해가 되는 행동이 발생하는 등의 <br/>
          경우가 보편적입니다.<br/> 
          <br/> 
          다음은 방패와 화살, <br/> 
          투구가 사용된 예시 입니다.
    ...
    content = (
      <>
        ...
        1) 봄 시즌, 4주차, <br/> 
        월요일 오전 10시에 브랜딩 팀장은 <br/> 
        정해진 일정에 따라, 주차 시작 브리핑<br/> 
        (커리큘럼, 세부진행)을 안내했고, <br/> 
        이에 대한 확인 투표를 <br/> 
        크루들에게 올렸다.<br/> 
        <br/> 
        2) 투표 마감 기한은, <br/> 
        그 다음날인 화요일 오후 14시까지로,<br/> 
        투표 소요시간은 10초 내외이다. <br/> 
        (‘확인했습니다’. 클릭)<br/> 
        <br/> 
        3) 화요일 오후 15시 경 기준,<br/> 
        브랜딩 팀 크루 10명 중 2명이 <br/> 
        투표를 하지 않았는데, <br/> 
        ‘홍길동’ 과 ‘강감찬’ 이었다.<br/> 
        <br/>  
        4) 팀장이 그 다음 주가 되어, <br/> 
        진행 결과를 검수하기 위해 <br/> 
        팔랑크스 동아리 시스템을 열람해본 <br/> 
        결과, ‘홍길동’ 은 해당 주차가 <br/> 
        ‘활동 주차’ (즉, 사전에 휴식 신청이<br/> 
        없었음)였고, ‘강감찬’ 은 <br/> 
        ‘휴식 주차’ 였다. <br/> 
         <br/> 
        5) 이에 팀장은 <br/> 
        ...
        태그하고 알렸다. <br/> 
        <br/> 
        ‘강감찬’ 은 휴식 주차이기 때문에 <br/> 
        미확인에 대한 페널티가 적용되지 <br/> 
        않았다.<br/> 
        <br/> 
        오전 10시 경, <br/> 
        “@홍길동, 안녕하세요 길동 크루님! <br/> 
        ...
        혹시 어려우신 부분이 있다면 <br/>
        알려주시기 바래요<br/> 
        금일 18시까지 회신 부탁드립니다.”<br/> 
        <br/> 
        6) 그러나 홍길동 크루는 <br/> 
        해당일 18시까지 회신이 없었고, <br/> 
        ‘화살’ 을 부여 받아, <br/> 
        방패가 하나 없어졌다.<br/>  
        <br/> 
      </>
    ...
    content = (
      <>
        ...
        브랜딩 팀의 산하 파트 ‘명품’ <br/>  
        파트에서, ‘홍길동’ 크루가 좋은 <br/>  
        기획안에 대한 피드백을 요청했고, <br/>  
        파트장은 이에 대해 모든 크루가 필수 <br/>  
        피드백을 통해, 전체의 기획안 <br/>  
        퀄리티를 올리고자 하였다. <br/>  
        <br/>  
        2) 이에 따라, <br/>  
        파트장은, 목요일 오후 14시 까지, <br/>  
        피드백을 단 크루들에게 ‘투구’ <br/>  
        3개를 부여하고자, 이를 팀장에게 <br/>  
        물어봤고, 승인을 받았다.<br/>   
        <br/>  
      ...
      <>
        <div style={{height : "100px"}}>
         <TitleSpan>1주 과정(1)</TitleSpan>
          ...
          기획/컨설팅 분야에서 떠오르는 <br/>
          트렌디한 이슈와 주제를 안내하고, <br/>
          이에 대한 깊은 인싸이트와 <br/>
          viewpoint를 육성하는 과정입니다.  <br/>
          Ex) “미디어 업계의 ai tool, <br/>
          미드저니를 우리 기획자들이 <br/>
          사용할 수 있는 시나리오는 <br/>
          어떻게 될까?”<br/>
          <br/>
          ㄷ. 주차 결산 <br/>
          매주 정해진 요일을 기준으로, <br/>
          지난 주 활동했던 모든 크루들의 <br/>
          활동 내역과 포인트, 진행 과정들을 <br/>
          검수하여 주차 활동 인정 여부를 <br/>
          공표하고, 주차별 우수 크루들을 <br/>
          선발합니다.<br/>
          <br/> 
          “악, 나 왜 화살 받았어!!ㅠ”<br/>
    ...
    content = (
      <>
        ...
        <br/>
          ㄱ. 정기 브리핑<br/>
          매주 월 / 수 / 토 를 기준으로, <br/>
          각 팀의 팀장이 자신의 팀 커리큘럼과 <br/>
          별도 조정 사항을 안내하고, <br/>
          각 파트장들의 리딩을 케어하여 <br/>
          모든 크루의 해당 주 포트폴리오 <br/>
          육성을 지원합니다.<br/>
          <br/>
          ㄴ. (필수형) 커리큘럼 유닛<br/>
          4단계의 기획 유닛 과정을 거쳐, <br/>
          내가 원하는 실제 기업/브랜드에게 <br/>
          나의 기획안을 공식 타진하는 <br/>
          활동을 진행합니다. <br/>
          <br/>
          이에 추가하여 다양한 크루들과 <br/>
          서로 기획안의 피드백을 주고받고, <br/>
          실제 기획 사례에 대한 분석 <br/>
          역시 포함됩니다. <br/>
          <br/>
          ㄷ. (필수형)  커리큘럼 유닛 <br/>
          기획/컨설팅 직무의 1~3년차 <br/>
          실무자들이 한창 익혀가는 <br/>
          실제 도구들과 전략, 전술, 개념 등을 <br/>
          1주에 1개씩 익혀가는 방식으로 <br/>
          나의 기획 역량을 쌓아갑니다. <br/>
          주차 인정 조건에 필수가 <br/>
          아닙니다.<br/> 
          <br/>
    ...
    content = (
      <>
        ...
        특별 과정 이란, <br/>
        모든 크루가 참여할 수 있는 <br/>
        비정기적 활동으로서, 클럽 내/외부와 <br/>
        연계하여 진행하는 ‘별도 과정’입니다.<br/>
        <br/>  
        ㄱ. 포럼<br/>
        각 팀에서 우수한 역량을 가지거나,<br/>
        뛰어난 결과를 낸 선배 크루들의 <br/>
        인사이트와 기획/컨설팅 부분에서의 <br/>
        역량 팁을 전수하는 소통 강의<br/>
        (온라인 혹은 오프라인) 입니다. <br/>
        <br/>
        ㄴ. 이벤트<br/>
        ...
        안내됩니다.<br/> 
        <br/>
        ㄷ. 특별행사 :올림피아 기획 대전<br/>
        클럽 팔랑크스의 대표 행사로서, <br/>
        매년 2, 8월을 기준으로 모든 <br/>
        크루가 필수 참석하는, 기획/컨설팅 <br/>
        분야의 경쟁 PT 행사입니다.<br/>
        <br/>
        팔랑크스와 후원/연계된 <br/>
        다양한 기업들의 실무진들의 참석과<br/>
        채용 연계가 이루어질 수 있습니다.<br/>
        경쟁 발표는 ‘파트’를 기준으로 <br/>
        합니다.<br/>
        <br/> 
        ㄹ. 실무 연계 프로젝트 <br/>
        클럽 팔랑크스의 활동 중 외부 기업과<br/>
        연계된 실무 프로젝트입니다. <br/>
        크루들의 기획안 또는 후원사의 <br/>
        연계로 진행되는 다양한 니즈의 <br/>
        기획들을 바탕으로 크루들의 실무 <br/>
        경력을 제고하고, 최고의 경험과 <br/>
        육성을 목표로 합니다. <br/>
        (수당, 기간, 보안 등이 포함된<br/>
    ...
    content = (
      <>
        ...
        개별 크루의 주차별 포트폴리오와 <br/>
        퍼포먼스 집계 내역서 <br/>
        (타진 기업들, 해당 과정, 결과, <br/>
        조회수, 외부 인사 피드백 등)<br/>
        <br/>
        *심화 크루는, 이와는 별도로 <br/>
        advanced 슬라이드를 추가 안내 <br/>받습니다.<br/>
        <br/>
        3) 기획/컨설팅 채용 추천서 <br/>
        -&gt;  팔랑크스 클럽 활동 중 우수한 <br/>
        기획 과정과 높은 열정, 노력을 <br/>
    ...
    content = (
      <>
        ...
        *팔랑크스의 알룸니 시스템은, <br/>
        ...
        기준으로, 후원사들이 진행 중인, <br/>
        기획/컨설팅 직무 관련 별도의 <br/>
        국가 공인 자격증에 대한 심사가 <br/>
        진행 중에 있습니다. <br/>
        (산업자원통상부 산하)<br/>
        심사가 최종 확정될 경우, <br/>
        팔랑크스 클럽의 졸업 크루들을 <br/>
        대상으로 필기/실기 전형을 면제하고, <br/>
    ...
    content = (
      <>
        ...
        것을 극도로 경계하며 이를 타 크루와 <br/>
        클럽 진행에 피해를 입히는 일이라고 <br/>
        간주합니다.<br/>
        <br/> 
        이에 따라 가장 페널티(화살 등)가 <br/>
        많이 발생하는 가장 중요한 일로서 <br/>
        아래 사항에 대해 단호히 재명시 <br/>
        드립니다.<br/>
        <br/>
        1. 단톡방을 통한 태그 및 안내<br/>
        -&gt; 팔랑크스 클럽의 활동을 <br/><br/>
        시작하게 되면, 각 크루가 사용하는 <br/>
        드라이브, 폴더, 아카이빙 포스팅 권한, <br/>
        네이밍 카드, 투표 시스템, 내부 <br/>
        운영 홈페이지 등 많은 클럽 인프라에 <br/>
        초대가 됩니다. <br/>
        <br/>
        여기서 가장 중요한 채널 중 하나는, <br/>
        팔랑크스 클럽 활동이 진행되는 <br/>
        여러 단톡들인데, 이 단톡은 팔랑크스 <br/>
        클럽의 활동이 진행되는 ‘공식적’인 <br/>
        채널이기 때문에 여기에서 <br/>
        ...
        24시간 이내에 답을 하는 것을 <br/>
        상식으로 갖추는 것을 추천드리며, <br/>
        단톡을 통해 본인에게 오는 다양한 <br/>
        메시지와 피드백 들을 확인 하는 것에 <br/>
        어려움을 느끼지 않는 마인드셋이 <br/>
        중요합니다. <br/>
        <br/>
        자신의 경력을 시작하는 <br/>
        포트폴리오를 쌓는 공적인 <br/>
    ...
    content = (
      <>
        ...
        2. 공지 사항에 대한 투표 및 확인<br/><br/>
        -&gt; 팔랑크스에서는, 미리 짜여진 <br/>
        일정과 과정을 포함하여 다양한 안내 <br/>
        및 리마인딩을 알리는 공지 사항이 <br/>
        올라옵니다.<br/>
        <br/>
        그리고 대부분의 공지 사항은, <br/>
        팔랑크스 클럽 시스템과 연동되는 <br/>
        투표를 포함하고 있는데, <br/>
        이 투표는 시즌 등록된 모든 <br/>
        크루들의 확인과 진행 과정에 대한 <br/>
        활동을 캐칭하여, 주차 인정 조건에 <br/>
        반영하는 과정으로 이루어집니다.<br/>
        <br/> 
        이에 따라 팔랑크스 클럽 활동 중에 <br/>
        발생하는 모든 공지사항을, 반드시 <br/>
        숙지하여야 하며 공지사항을 숙지하지 <br/>
        않을 시 발생하는 페널티와 불이익에 <br/>
    ...
    content = (
      <>
        ...
        -&gt; 활동을 시작하면, 내부 <br/>
        크루들에게만 공개되는, 전용 <br/>
        커뮤니케이션 페이지가 있기 때문에 <br/>
        이를 적극적으로 활용해주시면 <br/>
        원활하고 빠른 커뮤니케이션이 <br/>
        가능해집니다. <br/>
        <br/>
        또한 자꾸 1:1 의 개인 톡으로 <br/>
        공적인 활동을 진행하게 될 경우, <br/>
        당연하게도 해당 공간은 ‘사적’ 인 <br/>
        공간으로서, 운영 과정에서 <br/>
        어떤 책임이나 활동 내용에 대한  <br/>
        증빙이 곤란할 수 있습니다.<br/>
        <br/>
        클럽 활동 안에서 발생하는 <br/>
        여러 문의나 피드백, 내용은<br/>
         적극적으로 전체 톡을 사용하여 <br/>
         모든 크루의 대중 지성 인프라를 <br/>
         활용하는 것을 추천드리며, <br/>
         <br/>
         극히 사적인 비밀이나 프라이빗한 <br/>
         상황일 경우에는, <br/>
         커뮤니케이션 페이지를 활용해주시면 <br/>
         가장 효과적이고 원활한 진행이 <br/>
         가능합니다.<br/>
      </>
    );
    ...
    content = (
      <>
        ...
        이에 따라 팔랑크스 클럽의 <br/>
        활동 상에서의 커뮤니케이션을 <br/>
        통해, 지금까지 사적인 친구들과의 <br/>
        커뮤니케이션만 익숙한 대학생에서, <br/>
        사회에서 신뢰를 줄 수 있는 역량 있는 <br/>
        사회인으로서의 커뮤니케이션 연습을 <br/>
        할 수 있는 기회로 활용해야 합니다.<br/>
        <br/> 
        예를 들어, 사전에 정해진 일정이 아닌 <br/>
        경우 주말이나 밤에 갑작스럽게 보내는 <br/>
        커뮤니케이션은 실시간 회신을 <br/>
        기대하기 힘들며, 정해진 데드라인이나 <br/>
        마감 기한에 대한 것을 개인 임의의 <br/>
        사정으로 무시하거나 미룰 수 없다는, <br/>
        ‘당연한‘ 사항들을 익힐 수 있는 <br/>
        기회로 삼아주세요 <br/>
        <br/>
        2024년 기준, <br/>
        대한민국의 20대 청춘이 24시간 이상 <br/>
    ...
    content = (
      <>
        ...
        5. 나는 아직 <br/>
        케어가 필요한 청소년인가? <br/><br/>
        스스로 우뚝 설 수 있는 성인인가?<br/> 
        -&gt; 팔랑크스는, 30주의 기간과 내부의 <br/>
        커리큘럼과 진행과정, 그리고 증빙받는 <br/>
        결과물에서부터 타 동아리와 <br/>
        큰 차이를 가지고 있는 ‘클럽’ 형태의 <br/>
        동아리 입니다.<br/>
        <br/>
        그냥 좋은 추억과 썸 타고, <br/>
        친목 관계를 가지는 동아리 활동이 <br/>
        아니라, 많은 후원사와 연계 프로젝트, <br/>
        ...
        다양한 사람들이 모든 과정에서 함께 <br/>
        진행하고 있다는 사실을 꼭 염두에 <br/>
        두어야 합니다.<br/>
        <br/>
        신입생 때 그냥 놀려고 들어간 <br/>
