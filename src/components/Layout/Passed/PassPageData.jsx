            ...
            <PhBox>
              <ImgComponent2 imagePath={"GlassHedge.png"} 
                ...
                <YellowSpan><BiggerSpan>면접 진행 방식은!</BiggerSpan></YellowSpan> <br/>
                  ...
                  ‘공통의 포맷’ </BlueSpan>을 중심으로 진행하되, 각 <br/>
                  <OrangeSpan>면접관들이 준비한 ✨개별 문항✨들에서 <br/>
        ...
        <ImgComponent2 imagePath={"heart4.png"} 
            ...
            <PhBox>
                ...
                <YellowSpan><BiggerSpan>다음의 순서로 구성됩니다!<br/></BiggerSpan></YellowSpan>
                  ...
                  분야의 <GreenSpan>✨최고 동아리, 팔랑크스✨에<br/>
                  대한 간략한 개요</GreenSpan>를 재확인합니다. <br/>
                  <br/>
      ...
      <>
        ...
        <ImgComponent2 imagePath={"Babel.png"} 
            ...
            <PhBox>
                ...
                안되는 등 타 크루들에게 피해를 입히는 <br/>
                분보다는, 아직은 잘 못하더라도 팔랑크스의 <br/>
                진행 과정을 <YellowSpan>천천히 잘 따라오며 <br/>
      ...
      <>
       <SectionBlock>
            <PhBox>
                ...
                <BlueSpan>문의 시간</BlueSpan> 에 문의해주시기 바랍니다.  
                </div>
            </PhBox>
        </SectionBlock>
      </>
    ...
    content = (
      <>
       ...
       <PhBox>
                ...
                아래 양식으로 보내주세요. (필수)<br/>
                <br/><YellowSpan>
                "이름 / 면접일시 /팔랑크스 면접 참가 /  <br/>
                면접 안내 페이지 내용 확인하였습니다."
                 <br/></YellowSpan><RealGraySpan>
                 <br/>
                Ex)홍길동 / 1일(화) 12시 /  <br/>팔랑크스 면접 참가 / <br/> 
                면접 안내 페이지 내용 확인하였습니다.​<br/>
                <br/></RealGraySpan>
                *위 회신이 없는 경우, <br/>
